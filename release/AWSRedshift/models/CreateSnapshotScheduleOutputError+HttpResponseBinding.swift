...
extension CreateSnapshotScheduleOutputError {
    public init(errorType: Swift.String?, httpResponse: ClientRuntime.HttpResponse, decoder: ClientRuntime.ResponseDecoder? = nil, message: Swift.String? = nil, requestID: Swift.String? = nil) throws {
        ...
        case "ScheduleDefinitionTypeUnsupported" : self = .scheduleDefinitionTypeUnsupportedFault(try ScheduleDefinitionTypeUnsupportedFault(httpResponse: httpResponse, decoder: decoder, message: message, requestID: requestID))
