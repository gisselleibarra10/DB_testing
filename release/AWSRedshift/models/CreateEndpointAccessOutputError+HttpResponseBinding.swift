...
extension CreateEndpointAccessOutputError {
    public init(errorType: Swift.String?, httpResponse: ClientRuntime.HttpResponse, decoder: ClientRuntime.ResponseDecoder? = nil, message: Swift.String? = nil, requestID: Swift.String? = nil) throws {
        switch errorType {
        case "AccessToClusterDenied" : self = .accessToClusterDeniedFault(try AccessToClusterDeniedFault(httpResponse: httpResponse, decoder: decoder, message: message, requestID: requestID))
        ...
        case "EndpointAlreadyExists" : self = .endpointAlreadyExistsFault(try EndpointAlreadyExistsFault(httpResponse: httpResponse, decoder: decoder, message: message, requestID: requestID))
        case "EndpointsPerAuthorizationLimitExceeded" : self = .endpointsPerAuthorizationLimitExceededFault(try EndpointsPerAuthorizationLimitExceededFault(httpResponse: httpResponse, decoder: decoder, message: message, requestID: requestID))
        case "EndpointsPerClusterLimitExceeded" : self = .endpointsPerClusterLimitExceededFault(try EndpointsPerClusterLimitExceededFault(httpResponse: httpResponse, decoder: decoder, message: message, requestID: requestID))
