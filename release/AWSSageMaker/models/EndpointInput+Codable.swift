...
extension SageMakerClientTypes.EndpointInput: Swift.Codable {
    ...
    public func encode(to encoder: Swift.Encoder) throws {
        ...
        if let endTimeOffset = self.endTimeOffset {
        ...
        if let featuresAttribute = self.featuresAttribute {
            try encodeContainer.encode(featuresAttribute, forKey: .featuresAttribute)
        }
        if let inferenceAttribute = self.inferenceAttribute {
        ...
        if let probabilityAttribute = self.probabilityAttribute {
            try encodeContainer.encode(probabilityAttribute, forKey: .probabilityAttribute)
        }
        if let probabilityThresholdAttribute = self.probabilityThresholdAttribute {
        ...
        if let s3InputMode = self.s3InputMode {
            try encodeContainer.encode(s3InputMode.rawValue, forKey: .s3InputMode)
        }
        if let startTimeOffset = self.startTimeOffset {
