...
extension ListEdgeDeploymentPlansInput: Swift.Encodable {
    ...
    public func encode(to encoder: Swift.Encoder) throws {
        ...
        if let deviceFleetNameContains = self.deviceFleetNameContains {
            try encodeContainer.encode(deviceFleetNameContains, forKey: .deviceFleetNameContains)
        }
