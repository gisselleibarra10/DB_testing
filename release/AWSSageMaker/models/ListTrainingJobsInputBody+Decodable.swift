...
struct ListTrainingJobsInputBody: Swift.Equatable {
    ...
    let warmPoolStatusEquals: SageMakerClientTypes.WarmPoolResourceStatus?
}
...
extension ListTrainingJobsInputBody: Swift.Decodable {
    ...
    public init (from decoder: Swift.Decoder) throws {
        ...
        let warmPoolStatusEqualsDecoded = try containerValues.decodeIfPresent(SageMakerClientTypes.WarmPoolResourceStatus.self, forKey: .warmPoolStatusEquals)
        warmPoolStatusEquals = warmPoolStatusEqualsDecoded
    }
}
