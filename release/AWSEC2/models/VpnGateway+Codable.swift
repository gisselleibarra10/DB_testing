    ...
    public func encode(to encoder: Swift.Encoder) throws {
        ...
        if let vpcAttachments = vpcAttachments {
            if !vpcAttachments.isEmpty {
                ...
                var vpcAttachmentsContainer = container.nestedContainer(keyedBy: ClientRuntime.Key.self, forKey: ClientRuntime.Key("Attachments"))
                try vpcAttachmentsContainer.encode("", forKey: ClientRuntime.Key(""))
            }
        }
