    ...
    public func encode(to encoder: Swift.Encoder) throws {
        ...
        if let cidrBlockAssociationSet = cidrBlockAssociationSet {
            if !cidrBlockAssociationSet.isEmpty {
                ...
                var cidrBlockAssociationSetContainer = container.nestedContainer(keyedBy: ClientRuntime.Key.self, forKey: ClientRuntime.Key("CidrBlockAssociationSet"))
                try cidrBlockAssociationSetContainer.encode("", forKey: ClientRuntime.Key(""))
            }
        }
