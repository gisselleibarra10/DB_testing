...
extension GetNetworkInsightsAccessScopeContentInput: Swift.Encodable {
    public func encode(to encoder: Swift.Encoder) throws {
        ...
        try container.encode("GetNetworkInsightsAccessScopeContent", forKey:ClientRuntime.Key("Action"))
