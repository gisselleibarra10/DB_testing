...
extension GetTransitGatewayRouteTablePropagationsInput: Swift.Encodable {
    public func encode(to encoder: Swift.Encoder) throws {
        ...
        try container.encode("GetTransitGatewayRouteTablePropagations", forKey:ClientRuntime.Key("Action"))
