...
extension DescribeReservedInstancesListingsInput: Swift.Encodable {
    public func encode(to encoder: Swift.Encoder) throws {
        ...
        try container.encode("DescribeReservedInstancesListings", forKey:ClientRuntime.Key("Action"))
