...
extension EC2ClientTypes.LaunchTemplateInstanceNetworkInterfaceSpecificationRequest: Swift.Codable {
    ...
    public func encode(to encoder: Swift.Encoder) throws {
        ...
        if let ipv4Prefixes = ipv4Prefixes {
            if !ipv4Prefixes.isEmpty {
                ...
                var ipv4PrefixesContainer = container.nestedContainer(keyedBy: ClientRuntime.Key.self, forKey: ClientRuntime.Key("Ipv4Prefix"))
        ...
        if let ipv6Addresses = ipv6Addresses {
            if !ipv6Addresses.isEmpty {
                for (index0, instanceipv6addressrequest0) in ipv6Addresses.enumerated() {
                    ...
                    try ipv6AddressesContainer0.encode(instanceipv6addressrequest0, forKey: ClientRuntime.Key(""))
                }
            }
            else {
        ...
        if let privateIpAddresses = privateIpAddresses {
            if !privateIpAddresses.isEmpty {
                ...
                var privateIpAddressesContainer = container.nestedContainer(keyedBy: ClientRuntime.Key.self, forKey: ClientRuntime.Key("PrivateIpAddresses"))
    ...
    public init (from decoder: Swift.Decoder) throws {
        ...
        if containerValues.contains(.ipv6Addresses) {
            ...
            if let ipv6AddressesWrappedContainer = ipv6AddressesWrappedContainer {
                let ipv6AddressesContainer = try ipv6AddressesWrappedContainer.decodeIfPresent([EC2ClientTypes.InstanceIpv6AddressRequest].self, forKey: .member)
                var ipv6AddressesBuffer:[EC2ClientTypes.InstanceIpv6AddressRequest]? = nil
                if let ipv6AddressesContainer = ipv6AddressesContainer {
                    ipv6AddressesBuffer = [EC2ClientTypes.InstanceIpv6AddressRequest]()
