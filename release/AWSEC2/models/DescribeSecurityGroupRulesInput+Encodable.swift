...
extension DescribeSecurityGroupRulesInput: Swift.Encodable {
    public func encode(to encoder: Swift.Encoder) throws {
        ...
        if let securityGroupRuleIds = securityGroupRuleIds {
            if !securityGroupRuleIds.isEmpty {
                ...
                var securityGroupRuleIdsContainer = container.nestedContainer(keyedBy: ClientRuntime.Key.self, forKey: ClientRuntime.Key("SecurityGroupRuleId"))
                try securityGroupRuleIdsContainer.encode("", forKey: ClientRuntime.Key(""))
            }
        }
        try container.encode("DescribeSecurityGroupRules", forKey:ClientRuntime.Key("Action"))
