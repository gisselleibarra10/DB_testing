...
extension AcceptTransitGatewayPeeringAttachmentInput: Swift.Encodable {
    public func encode(to encoder: Swift.Encoder) throws {
        ...
        try container.encode("AcceptTransitGatewayPeeringAttachment", forKey:ClientRuntime.Key("Action"))
