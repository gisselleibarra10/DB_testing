    ...
    public func encode(to encoder: Swift.Encoder) throws {
        ...
        if let poolCidrBlocks = poolCidrBlocks {
            if !poolCidrBlocks.isEmpty {
                ...
                var poolCidrBlocksContainer = container.nestedContainer(keyedBy: ClientRuntime.Key.self, forKey: ClientRuntime.Key("PoolCidrBlockSet"))
                try poolCidrBlocksContainer.encode("", forKey: ClientRuntime.Key(""))
            }
        }
