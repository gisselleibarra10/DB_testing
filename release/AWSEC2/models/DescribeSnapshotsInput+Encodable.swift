    ...
    public func encode(to encoder: Swift.Encoder) throws {
        ...
        if let ownerIds = ownerIds {
            if !ownerIds.isEmpty {
                ...
                var ownerIdsContainer = container.nestedContainer(keyedBy: ClientRuntime.Key.self, forKey: ClientRuntime.Key("Owner"))
                try ownerIdsContainer.encode("", forKey: ClientRuntime.Key(""))
            }
        }
        if let restorableByUserIds = restorableByUserIds {
            if !restorableByUserIds.isEmpty {
                ...
                var restorableByUserIdsContainer = container.nestedContainer(keyedBy: ClientRuntime.Key.self, forKey: ClientRuntime.Key("RestorableBy"))
                try restorableByUserIdsContainer.encode("", forKey: ClientRuntime.Key(""))
            }
        }
