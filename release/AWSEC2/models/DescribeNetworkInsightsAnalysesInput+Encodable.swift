...
extension DescribeNetworkInsightsAnalysesInput: Swift.Encodable {
    public func encode(to encoder: Swift.Encoder) throws {
        ...
        if let analysisEndTime = analysisEndTime {
            try container.encode(ClientRuntime.TimestampWrapper(analysisEndTime, format: .dateTime), forKey: ClientRuntime.Key("AnalysisEndTime"))
        }
        if let analysisStartTime = analysisStartTime {
            try container.encode(ClientRuntime.TimestampWrapper(analysisStartTime, format: .dateTime), forKey: ClientRuntime.Key("AnalysisStartTime"))
        }
