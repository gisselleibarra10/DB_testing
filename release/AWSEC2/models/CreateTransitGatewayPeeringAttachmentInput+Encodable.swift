...
extension CreateTransitGatewayPeeringAttachmentInput: Swift.Encodable {
    public func encode(to encoder: Swift.Encoder) throws {
        ...
        if let peerAccountId = peerAccountId {
            try container.encode(peerAccountId, forKey: ClientRuntime.Key("PeerAccountId"))
        }
        ...
        try container.encode("CreateTransitGatewayPeeringAttachment", forKey:ClientRuntime.Key("Action"))
