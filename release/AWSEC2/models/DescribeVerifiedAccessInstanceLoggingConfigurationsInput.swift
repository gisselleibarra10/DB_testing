...
public struct DescribeVerifiedAccessInstanceLoggingConfigurationsInput: Swift.Equatable {
    ...
    public var verifiedAccessInstanceIds: [Swift.String]?
    ...
    public init (
        ...
        verifiedAccessInstanceIds: [Swift.String]? = nil
    )
    {
        self.dryRun = dryRun
