...
extension EC2ClientTypes.RegisterInstanceTagAttributeRequest: Swift.Codable {
    ...
    public func encode(to encoder: Swift.Encoder) throws {
        ...
        if let instanceTagKeys = instanceTagKeys {
            if !instanceTagKeys.isEmpty {
                ...
                var instanceTagKeysContainer = container.nestedContainer(keyedBy: ClientRuntime.Key.self, forKey: ClientRuntime.Key("InstanceTagKey"))
