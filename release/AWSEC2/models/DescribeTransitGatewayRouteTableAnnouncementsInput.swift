...
public struct DescribeTransitGatewayRouteTableAnnouncementsInput: Swift.Equatable {
    ...
    public var transitGatewayRouteTableAnnouncementIds: [Swift.String]?
    ...
    public init (
        ...
        transitGatewayRouteTableAnnouncementIds: [Swift.String]? = nil
    )
    {
        self.dryRun = dryRun
