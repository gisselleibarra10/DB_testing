...
extension DescribeVpcEndpointServicePermissionsInput: Swift.Encodable {
    public func encode(to encoder: Swift.Encoder) throws {
        ...
        try container.encode("DescribeVpcEndpointServicePermissions", forKey:ClientRuntime.Key("Action"))
