...
public struct ModifyVerifiedAccessInstanceLoggingConfigurationInput: Swift.Equatable {
    /// The configuration options for Amazon Web Services Verified Access instances.
    /// This member is required.
    public var accessLogs: EC2ClientTypes.VerifiedAccessLogOptions?
    ...
    public init (
        accessLogs: EC2ClientTypes.VerifiedAccessLogOptions? = nil,
