...
extension DisassociateTransitGatewayMulticastDomainInput: Swift.Encodable {
    public func encode(to encoder: Swift.Encoder) throws {
        ...
        try container.encode("DisassociateTransitGatewayMulticastDomain", forKey:ClientRuntime.Key("Action"))
