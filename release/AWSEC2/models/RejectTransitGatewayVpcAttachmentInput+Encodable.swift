...
extension RejectTransitGatewayVpcAttachmentInput: Swift.Encodable {
    public func encode(to encoder: Swift.Encoder) throws {
        ...
        try container.encode("RejectTransitGatewayVpcAttachment", forKey:ClientRuntime.Key("Action"))
