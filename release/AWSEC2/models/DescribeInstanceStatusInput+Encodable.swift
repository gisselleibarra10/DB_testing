...
extension DescribeInstanceStatusInput: Swift.Encodable {
    public func encode(to encoder: Swift.Encoder) throws {
        ...
        if let includeAllInstances = includeAllInstances {
            try container.encode(includeAllInstances, forKey: ClientRuntime.Key("IncludeAllInstances"))
        }
        ...
        try container.encode("DescribeInstanceStatus", forKey:ClientRuntime.Key("Action"))
