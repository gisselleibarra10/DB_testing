    ...
    public func encode(to encoder: Swift.Encoder) throws {
        ...
        if let addGatewayLoadBalancerArns = addGatewayLoadBalancerArns {
            if !addGatewayLoadBalancerArns.isEmpty {
                ...
                var addGatewayLoadBalancerArnsContainer = container.nestedContainer(keyedBy: ClientRuntime.Key.self, forKey: ClientRuntime.Key("AddGatewayLoadBalancerArn"))
                try addGatewayLoadBalancerArnsContainer.encode("", forKey: ClientRuntime.Key(""))
            }
        }
        if let addNetworkLoadBalancerArns = addNetworkLoadBalancerArns {
            if !addNetworkLoadBalancerArns.isEmpty {
                ...
                var addNetworkLoadBalancerArnsContainer = container.nestedContainer(keyedBy: ClientRuntime.Key.self, forKey: ClientRuntime.Key("AddNetworkLoadBalancerArn"))
                try addNetworkLoadBalancerArnsContainer.encode("", forKey: ClientRuntime.Key(""))
            }
        }
        if let addSupportedIpAddressTypes = addSupportedIpAddressTypes {
            if !addSupportedIpAddressTypes.isEmpty {
                ...
                var addSupportedIpAddressTypesContainer = container.nestedContainer(keyedBy: ClientRuntime.Key.self, forKey: ClientRuntime.Key("AddSupportedIpAddressType"))
                try addSupportedIpAddressTypesContainer.encode("", forKey: ClientRuntime.Key(""))
            }
        }
        ...
        if let removeGatewayLoadBalancerArns = removeGatewayLoadBalancerArns {
            if !removeGatewayLoadBalancerArns.isEmpty {
                ...
                var removeGatewayLoadBalancerArnsContainer = container.nestedContainer(keyedBy: ClientRuntime.Key.self, forKey: ClientRuntime.Key("RemoveGatewayLoadBalancerArn"))
                try removeGatewayLoadBalancerArnsContainer.encode("", forKey: ClientRuntime.Key(""))
            }
        }
        if let removeNetworkLoadBalancerArns = removeNetworkLoadBalancerArns {
            if !removeNetworkLoadBalancerArns.isEmpty {
                ...
                var removeNetworkLoadBalancerArnsContainer = container.nestedContainer(keyedBy: ClientRuntime.Key.self, forKey: ClientRuntime.Key("RemoveNetworkLoadBalancerArn"))
                try removeNetworkLoadBalancerArnsContainer.encode("", forKey: ClientRuntime.Key(""))
            }
        }
        ...
        if let removeSupportedIpAddressTypes = removeSupportedIpAddressTypes {
            if !removeSupportedIpAddressTypes.isEmpty {
                ...
                var removeSupportedIpAddressTypesContainer = container.nestedContainer(keyedBy: ClientRuntime.Key.self, forKey: ClientRuntime.Key("RemoveSupportedIpAddressType"))
                try removeSupportedIpAddressTypesContainer.encode("", forKey: ClientRuntime.Key(""))
            }
        }
