...
extension AssociateTransitGatewayRouteTableInput: Swift.Encodable {
    public func encode(to encoder: Swift.Encoder) throws {
        ...
        try container.encode("AssociateTransitGatewayRouteTable", forKey:ClientRuntime.Key("Action"))
