    ...
    public func encode(to encoder: Swift.Encoder) throws {
        ...
        if let loadPermissions = loadPermissions {
            if !loadPermissions.isEmpty {
                ...
                var loadPermissionsContainer = container.nestedContainer(keyedBy: ClientRuntime.Key.self, forKey: ClientRuntime.Key("LoadPermissions"))
                try loadPermissionsContainer.encode("", forKey: ClientRuntime.Key(""))
            }
        }
        if let name = name {
