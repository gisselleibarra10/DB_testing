    ...
    public func encode(to encoder: Swift.Encoder) throws {
        ...
        if let exportTaskIds = exportTaskIds {
            if !exportTaskIds.isEmpty {
                ...
                var exportTaskIdsContainer = container.nestedContainer(keyedBy: ClientRuntime.Key.self, forKey: ClientRuntime.Key("ExportTaskId"))
                try exportTaskIdsContainer.encode("", forKey: ClientRuntime.Key(""))
            }
        }
