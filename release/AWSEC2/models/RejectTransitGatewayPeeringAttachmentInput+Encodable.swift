...
extension RejectTransitGatewayPeeringAttachmentInput: Swift.Encodable {
    public func encode(to encoder: Swift.Encoder) throws {
        ...
        try container.encode("RejectTransitGatewayPeeringAttachment", forKey:ClientRuntime.Key("Action"))
