    ...
    public func encode(to encoder: Swift.Encoder) throws {
        ...
        if let elasticGpuSpecification = elasticGpuSpecification {
            if !elasticGpuSpecification.isEmpty {
                ...
                var elasticGpuSpecificationContainer = container.nestedContainer(keyedBy: ClientRuntime.Key.self, forKey: ClientRuntime.Key("ElasticGpuSpecification"))
                try elasticGpuSpecificationContainer.encode("", forKey: ClientRuntime.Key(""))
            }
        }
