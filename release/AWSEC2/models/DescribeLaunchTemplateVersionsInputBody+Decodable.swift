...
struct DescribeLaunchTemplateVersionsInputBody: Swift.Equatable {
    let dryRun: Swift.Bool?
    let launchTemplateId: Swift.String?
    let launchTemplateName: Swift.String?
    let versions: [Swift.String]?
    let minVersion: Swift.String?
    let maxVersion: Swift.String?
    let nextToken: Swift.String?
    let maxResults: Swift.Int?
    let filters: [Ec2ClientTypes.Filter]?
}

extension DescribeLaunchTemplateVersionsInputBody: Swift.Decodable {
    ...
    public init (from decoder: Swift.Decoder) throws {
        ...
        let minVersionDecoded = try containerValues.decodeIfPresent(Swift.String.self, forKey: .minVersion)
        minVersion = minVersionDecoded
        let maxVersionDecoded = try containerValues.decodeIfPresent(Swift.String.self, forKey: .maxVersion)
        maxVersion = maxVersionDecoded
