...
extension RegisterTransitGatewayMulticastGroupMembersInput: Swift.Encodable {
    public func encode(to encoder: Swift.Encoder) throws {
        ...
        try container.encode("RegisterTransitGatewayMulticastGroupMembers", forKey:ClientRuntime.Key("Action"))
