...
public struct DescribeLocalGatewayRouteTableVpcAssociationsInput: Swift.Equatable {
    ...
    public var localGatewayRouteTableVpcAssociationIds: [Swift.String]?
    ...
    public init (
        ...
        localGatewayRouteTableVpcAssociationIds: [Swift.String]? = nil,
