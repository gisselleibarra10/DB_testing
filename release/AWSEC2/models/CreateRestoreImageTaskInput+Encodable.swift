...
extension CreateRestoreImageTaskInput: Swift.Encodable {
    public func encode(to encoder: Swift.Encoder) throws {
        ...
        if let objectKey = objectKey {
            try container.encode(objectKey, forKey: ClientRuntime.Key("ObjectKey"))
        }
        ...
        try container.encode("CreateRestoreImageTask", forKey:ClientRuntime.Key("Action"))
