    ...
    public func encode(to encoder: Swift.Encoder) throws {
        ...
        if let architectureTypes = architectureTypes {
            if !architectureTypes.isEmpty {
                ...
                var architectureTypesContainer = container.nestedContainer(keyedBy: ClientRuntime.Key.self, forKey: ClientRuntime.Key("ArchitectureType"))
                try architectureTypesContainer.encode("", forKey: ClientRuntime.Key(""))
            }
        }
        ...
        if let virtualizationTypes = virtualizationTypes {
            if !virtualizationTypes.isEmpty {
                ...
                var virtualizationTypesContainer = container.nestedContainer(keyedBy: ClientRuntime.Key.self, forKey: ClientRuntime.Key("VirtualizationType"))
                try virtualizationTypesContainer.encode("", forKey: ClientRuntime.Key(""))
            }
        }
