...
extension EC2ClientTypes.NewDhcpConfiguration: Swift.Codable {
        ...
        if let values = values {
            if !values.isEmpty {
                for (index0, string0) in values.enumerated() {
                    var valuesContainer0 = container.nestedContainer(keyedBy: ClientRuntime.Key.self, forKey: ClientRuntime.Key("Value.\(index0.advanced(by: 1))"))
