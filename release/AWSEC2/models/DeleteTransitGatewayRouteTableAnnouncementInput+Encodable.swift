...
extension DeleteTransitGatewayRouteTableAnnouncementInput: Swift.Encodable {
    public func encode(to encoder: Swift.Encoder) throws {
        ...
        try container.encode("DeleteTransitGatewayRouteTableAnnouncement", forKey:ClientRuntime.Key("Action"))
