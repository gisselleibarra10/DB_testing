...
extension EC2ClientTypes.IpamAddressHistoryRecord: Swift.Codable {
    ...
    public func encode(to encoder: Swift.Encoder) throws {
        ...
        if let sampledEndTime = sampledEndTime {
            try container.encodeTimestamp(sampledEndTime, format: .dateTime, forKey: ClientRuntime.Key("SampledEndTime"))
        }
        if let sampledStartTime = sampledStartTime {
            try container.encodeTimestamp(sampledStartTime, format: .dateTime, forKey: ClientRuntime.Key("SampledStartTime"))
        }
        if let vpcId = vpcId {
    ...
    public init (from decoder: Swift.Decoder) throws {
        ...
        vpcId = vpcIdDecoded
        let sampledStartTimeDecoded = try containerValues.decodeTimestampIfPresent(.dateTime, forKey: .sampledStartTime)
        sampledStartTime = sampledStartTimeDecoded
        let sampledEndTimeDecoded = try containerValues.decodeTimestampIfPresent(.dateTime, forKey: .sampledEndTime)
        sampledEndTime = sampledEndTimeDecoded
    }
}
