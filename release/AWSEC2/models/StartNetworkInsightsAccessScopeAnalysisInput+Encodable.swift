...
extension StartNetworkInsightsAccessScopeAnalysisInput: Swift.Encodable {
    public func encode(to encoder: Swift.Encoder) throws {
        ...
        try container.encode("StartNetworkInsightsAccessScopeAnalysis", forKey:ClientRuntime.Key("Action"))
