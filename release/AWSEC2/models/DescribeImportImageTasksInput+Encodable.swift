...
extension DescribeImportImageTasksInput: Swift.Encodable {
    public func encode(to encoder: Swift.Encoder) throws {
        ...
        if let importTaskIds = importTaskIds {
            if !importTaskIds.isEmpty {
                for (index0, importimagetaskid0) in importTaskIds.enumerated() {
                    ...
                    try importTaskIdsContainer0.encode(importimagetaskid0, forKey: ClientRuntime.Key(""))
                }
            }
            else {
        ...
        try container.encode("DescribeImportImageTasks", forKey:ClientRuntime.Key("Action"))
