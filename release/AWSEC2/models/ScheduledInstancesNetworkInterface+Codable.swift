    ...
    public func encode(to encoder: Swift.Encoder) throws {
        ...
        if let groups = groups {
            if !groups.isEmpty {
                ...
                var groupsContainer = container.nestedContainer(keyedBy: ClientRuntime.Key.self, forKey: ClientRuntime.Key("Group"))
        ...
        if let ipv6Addresses = ipv6Addresses {
            if !ipv6Addresses.isEmpty {
                ...
                var ipv6AddressesContainer = container.nestedContainer(keyedBy: ClientRuntime.Key.self, forKey: ClientRuntime.Key("Ipv6Address"))
        ...
        if let privateIpAddressConfigs = privateIpAddressConfigs {
            if !privateIpAddressConfigs.isEmpty {
                ...
                var privateIpAddressConfigsContainer = container.nestedContainer(keyedBy: ClientRuntime.Key.self, forKey: ClientRuntime.Key("PrivateIpAddressConfig"))
                try privateIpAddressConfigsContainer.encode("", forKey: ClientRuntime.Key(""))
            }
        }
