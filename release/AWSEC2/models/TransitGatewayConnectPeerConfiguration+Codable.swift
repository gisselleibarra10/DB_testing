    ...
    public func encode(to encoder: Swift.Encoder) throws {
        ...
        if let bgpConfigurations = bgpConfigurations {
            if !bgpConfigurations.isEmpty {
                ...
                var bgpConfigurationsContainer = container.nestedContainer(keyedBy: ClientRuntime.Key.self, forKey: ClientRuntime.Key("BgpConfigurations"))
                try bgpConfigurationsContainer.encode("", forKey: ClientRuntime.Key(""))
            }
        }
