...
public struct DescribeLocalGatewayRouteTablesInput: Swift.Equatable {
    ...
    public var localGatewayRouteTableIds: [Swift.String]?
    ...
    public init (
        ...
        localGatewayRouteTableIds: [Swift.String]? = nil,
