...
extension AcceptTransitGatewayMulticastDomainAssociationsInput: Swift.Encodable {
    public func encode(to encoder: Swift.Encoder) throws {
        ...
        try container.encode("AcceptTransitGatewayMulticastDomainAssociations", forKey:ClientRuntime.Key("Action"))
