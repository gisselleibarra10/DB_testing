...
extension Ec2ClientTypes.Instance: Swift.Codable {
    ...
    public func encode(to encoder: Swift.Encoder) throws {
        ...
        if let launchTime = launchTime {
            try container.encode(ClientRuntime.TimestampWrapper(launchTime, format: .dateTime), forKey: ClientRuntime.Key("LaunchTime"))
        }
        ...
        if let usageOperationUpdateTime = usageOperationUpdateTime {
            try container.encode(ClientRuntime.TimestampWrapper(usageOperationUpdateTime, format: .dateTime), forKey: ClientRuntime.Key("UsageOperationUpdateTime"))
        }
    ...
    public init (from decoder: Swift.Decoder) throws {
        ...
        var launchTimeBuffer:ClientRuntime.Date? = nil
        if let launchTimeDecoded = launchTimeDecoded {
            launchTimeBuffer = try ClientRuntime.TimestampWrapperDecoder.parseDateStringValue(launchTimeDecoded, format: .dateTime)
        }
        ...
        let usageOperationUpdateTimeDecoded = try containerValues.decodeIfPresent(Swift.String.self, forKey: .usageOperationUpdateTime)
        var usageOperationUpdateTimeBuffer:ClientRuntime.Date? = nil
        if let usageOperationUpdateTimeDecoded = usageOperationUpdateTimeDecoded {
            usageOperationUpdateTimeBuffer = try ClientRuntime.TimestampWrapperDecoder.parseDateStringValue(usageOperationUpdateTimeDecoded, format: .dateTime)
        }
        usageOperationUpdateTime = usageOperationUpdateTimeBuffer
