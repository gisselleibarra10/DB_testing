...
extension EC2ClientTypes.SnapshotTierStatus: Swift.Codable {
    ...
    public func encode(to encoder: Swift.Encoder) throws {
        ...
        if let archivalCompleteTime = archivalCompleteTime {
            try container.encodeTimestamp(archivalCompleteTime, format: .dateTime, forKey: ClientRuntime.Key("ArchivalCompleteTime"))
        }
        ...
        if let lastTieringStartTime = lastTieringStartTime {
            try container.encodeTimestamp(lastTieringStartTime, format: .dateTime, forKey: ClientRuntime.Key("LastTieringStartTime"))
        }
    ...
    public init (from decoder: Swift.Decoder) throws {
        ...
        let lastTieringStartTimeDecoded = try containerValues.decodeTimestampIfPresent(.dateTime, forKey: .lastTieringStartTime)
        lastTieringStartTime = lastTieringStartTimeDecoded
        ...
        archivalCompleteTime = archivalCompleteTimeDecoded
