...
extension DescribeInstanceCreditSpecificationsInput: Swift.Encodable {
    public func encode(to encoder: Swift.Encoder) throws {
        ...
        try container.encode("DescribeInstanceCreditSpecifications", forKey:ClientRuntime.Key("Action"))
