...
extension DisassociateTransitGatewayRouteTableInput: Swift.Encodable {
    public func encode(to encoder: Swift.Encoder) throws {
        ...
        try container.encode("DisassociateTransitGatewayRouteTable", forKey:ClientRuntime.Key("Action"))
