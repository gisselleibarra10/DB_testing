...
extension GetTransitGatewayPolicyTableEntriesInput: Swift.Encodable {
    public func encode(to encoder: Swift.Encoder) throws {
        ...
        try container.encode("GetTransitGatewayPolicyTableEntries", forKey:ClientRuntime.Key("Action"))
