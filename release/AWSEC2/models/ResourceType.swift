...
extension EC2ClientTypes {
    public enum ResourceType: Swift.Equatable, Swift.RawRepresentable, Swift.CaseIterable, Swift.Codable, Swift.Hashable {
        ...
        public var rawValue: Swift.String {
            ...
            case .verifiedAccessEndpoint: return "verified-access-endpoint"
            case .verifiedAccessGroup: return "verified-access-group"
            case .verifiedAccessInstance: return "verified-access-instance"
            case .verifiedAccessPolicy: return "verified-access-policy"
            case .verifiedAccessTrustProvider: return "verified-access-trust-provider"
            case .volume: return "volume"
            case .vpc: return "vpc"
            case .vpcBlockPublicAccessExclusion: return "vpc-block-public-access-exclusion"
