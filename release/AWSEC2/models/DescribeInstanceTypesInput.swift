...
public struct DescribeInstanceTypesInput: Swift.Equatable {
    ...
    /// The instance types. For more information, see [Instance types](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/instance-types.html) in the Amazon EC2 User Guide.
