...
extension EC2ClientTypes.InstanceBlockDeviceMappingSpecification: Swift.Codable {
    ...
    public init (from decoder: Swift.Decoder) throws {
        ...
        let ebsDecoded = try containerValues.decodeIfPresent(EC2ClientTypes.EbsInstanceBlockDeviceSpecification.self, forKey: .ebs)
        ebs = ebsDecoded
