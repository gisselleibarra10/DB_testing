...
extension GetTransitGatewayAttachmentPropagationsInput: Swift.Encodable {
    public func encode(to encoder: Swift.Encoder) throws {
        ...
        try container.encode("GetTransitGatewayAttachmentPropagations", forKey:ClientRuntime.Key("Action"))
