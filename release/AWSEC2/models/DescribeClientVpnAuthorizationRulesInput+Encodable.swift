...
extension DescribeClientVpnAuthorizationRulesInput: Swift.Encodable {
    public func encode(to encoder: Swift.Encoder) throws {
        ...
        try container.encode("DescribeClientVpnAuthorizationRules", forKey:ClientRuntime.Key("Action"))
