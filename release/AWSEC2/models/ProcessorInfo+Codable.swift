    ...
    public func encode(to encoder: Swift.Encoder) throws {
        ...
        if let supportedArchitectures = supportedArchitectures {
            if !supportedArchitectures.isEmpty {
                ...
                var supportedArchitecturesContainer = container.nestedContainer(keyedBy: ClientRuntime.Key.self, forKey: ClientRuntime.Key("SupportedArchitectures"))
                try supportedArchitecturesContainer.encode("", forKey: ClientRuntime.Key(""))
            }
        }
