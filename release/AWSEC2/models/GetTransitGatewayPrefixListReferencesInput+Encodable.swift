...
extension GetTransitGatewayPrefixListReferencesInput: Swift.Encodable {
    public func encode(to encoder: Swift.Encoder) throws {
        ...
        try container.encode("GetTransitGatewayPrefixListReferences", forKey:ClientRuntime.Key("Action"))
