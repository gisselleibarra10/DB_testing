...
extension AcceptTransitGatewayVpcAttachmentInput: Swift.Encodable {
    public func encode(to encoder: Swift.Encoder) throws {
        ...
        try container.encode("AcceptTransitGatewayVpcAttachment", forKey:ClientRuntime.Key("Action"))
