...
extension EnableTransitGatewayRouteTablePropagationInput: Swift.Encodable {
    public func encode(to encoder: Swift.Encoder) throws {
        ...
        try container.encode("EnableTransitGatewayRouteTablePropagation", forKey:ClientRuntime.Key("Action"))
