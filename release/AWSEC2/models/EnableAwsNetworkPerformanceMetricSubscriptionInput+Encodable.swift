...
extension EnableAwsNetworkPerformanceMetricSubscriptionInput: Swift.Encodable {
    public func encode(to encoder: Swift.Encoder) throws {
        ...
        try container.encode("EnableAwsNetworkPerformanceMetricSubscription", forKey:ClientRuntime.Key("Action"))
