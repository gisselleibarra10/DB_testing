...
extension EC2ClientTypes.InstanceRequirementsRequest: Swift.Codable {
    ...
    public func encode(to encoder: Swift.Encoder) throws {
        ...
        if let acceleratorManufacturers = acceleratorManufacturers {
            if !acceleratorManufacturers.isEmpty {
                ...
                var acceleratorManufacturersContainer = container.nestedContainer(keyedBy: ClientRuntime.Key.self, forKey: ClientRuntime.Key("AcceleratorManufacturer"))
        ...
        if let acceleratorNames = acceleratorNames {
            if !acceleratorNames.isEmpty {
                ...
                var acceleratorNamesContainer = container.nestedContainer(keyedBy: ClientRuntime.Key.self, forKey: ClientRuntime.Key("AcceleratorName"))
        ...
        if let acceleratorTypes = acceleratorTypes {
            if !acceleratorTypes.isEmpty {
                ...
                var acceleratorTypesContainer = container.nestedContainer(keyedBy: ClientRuntime.Key.self, forKey: ClientRuntime.Key("AcceleratorType"))
        ...
        if let allowedInstanceTypes = allowedInstanceTypes {
            if !allowedInstanceTypes.isEmpty {
                for (index0, allowedinstancetype0) in allowedInstanceTypes.enumerated() {
                    var allowedInstanceTypesContainer0 = container.nestedContainer(keyedBy: ClientRuntime.Key.self, forKey: ClientRuntime.Key("AllowedInstanceType.\(index0.advanced(by: 1))"))
                    try allowedInstanceTypesContainer0.encode(allowedinstancetype0, forKey: ClientRuntime.Key(""))
                }
            }
            else {
                var allowedInstanceTypesContainer = container.nestedContainer(keyedBy: ClientRuntime.Key.self, forKey: ClientRuntime.Key("AllowedInstanceType"))
        ...
        if let cpuManufacturers = cpuManufacturers {
            if !cpuManufacturers.isEmpty {
                ...
                var cpuManufacturersContainer = container.nestedContainer(keyedBy: ClientRuntime.Key.self, forKey: ClientRuntime.Key("CpuManufacturer"))
        ...
        if let excludedInstanceTypes = excludedInstanceTypes {
            if !excludedInstanceTypes.isEmpty {
                ...
                var excludedInstanceTypesContainer = container.nestedContainer(keyedBy: ClientRuntime.Key.self, forKey: ClientRuntime.Key("ExcludedInstanceType"))
        ...
        if let instanceGenerations = instanceGenerations {
            if !instanceGenerations.isEmpty {
                ...
                var instanceGenerationsContainer = container.nestedContainer(keyedBy: ClientRuntime.Key.self, forKey: ClientRuntime.Key("InstanceGeneration"))
        ...
        if let localStorageTypes = localStorageTypes {
            if !localStorageTypes.isEmpty {
                ...
                var localStorageTypesContainer = container.nestedContainer(keyedBy: ClientRuntime.Key.self, forKey: ClientRuntime.Key("LocalStorageType"))
    ...
    public init (from decoder: Swift.Decoder) throws {
        ...
        let networkBandwidthGbpsDecoded = try containerValues.decodeIfPresent(EC2ClientTypes.NetworkBandwidthGbpsRequest.self, forKey: .networkBandwidthGbps)
