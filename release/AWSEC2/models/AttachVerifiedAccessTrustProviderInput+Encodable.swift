...
extension AttachVerifiedAccessTrustProviderInput: Swift.Encodable {
    public func encode(to encoder: Swift.Encoder) throws {
        ...
        try container.encode("AttachVerifiedAccessTrustProvider", forKey:ClientRuntime.Key("Action"))
