...
extension CreateLocalGatewayRouteTableVirtualInterfaceGroupAssociationInput: Swift.Encodable {
    public func encode(to encoder: Swift.Encoder) throws {
        ...
        try container.encode("CreateLocalGatewayRouteTableVirtualInterfaceGroupAssociation", forKey:ClientRuntime.Key("Action"))
