    ...
    public func encode(to encoder: Swift.Encoder) throws {
        ...
        if let gatewayLoadBalancerArns = gatewayLoadBalancerArns {
            if !gatewayLoadBalancerArns.isEmpty {
                ...
                var gatewayLoadBalancerArnsContainer = container.nestedContainer(keyedBy: ClientRuntime.Key.self, forKey: ClientRuntime.Key("GatewayLoadBalancerArn"))
        ...
        if let networkLoadBalancerArns = networkLoadBalancerArns {
            if !networkLoadBalancerArns.isEmpty {
                ...
                var networkLoadBalancerArnsContainer = container.nestedContainer(keyedBy: ClientRuntime.Key.self, forKey: ClientRuntime.Key("NetworkLoadBalancerArn"))
        ...
        if let supportedIpAddressTypes = supportedIpAddressTypes {
            if !supportedIpAddressTypes.isEmpty {
                ...
                var supportedIpAddressTypesContainer = container.nestedContainer(keyedBy: ClientRuntime.Key.self, forKey: ClientRuntime.Key("SupportedIpAddressType"))
