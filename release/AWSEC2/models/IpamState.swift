...
extension EC2ClientTypes {
    public enum IpamState: Swift.Equatable, Swift.RawRepresentable, Swift.CaseIterable, Swift.Codable, Swift.Hashable {
        case createComplete
        case createFailed
        ...
        public static var allCases: [IpamState] {
            return [
                .createComplete,
                .createFailed,
                .createInProgress,
        ...
        public init(from decoder: Swift.Decoder) throws {
            ...
            self = IpamState(rawValue: rawValue) ?? IpamState.sdkUnknown(rawValue)
        }
    }
}
