    ...
    public func encode(to encoder: Swift.Encoder) throws {
        ...
        if let ipv6Ranges = ipv6Ranges {
            if !ipv6Ranges.isEmpty {
                ...
                var ipv6RangesContainer = container.nestedContainer(keyedBy: ClientRuntime.Key.self, forKey: ClientRuntime.Key("Ipv6Ranges"))
                try ipv6RangesContainer.encode("", forKey: ClientRuntime.Key(""))
            }
        }
        if let prefixListIds = prefixListIds {
            if !prefixListIds.isEmpty {
                ...
                var prefixListIdsContainer = container.nestedContainer(keyedBy: ClientRuntime.Key.self, forKey: ClientRuntime.Key("PrefixListIds"))
                try prefixListIdsContainer.encode("", forKey: ClientRuntime.Key(""))
            }
        }
        ...
        if let userIdGroupPairs = userIdGroupPairs {
            if !userIdGroupPairs.isEmpty {
                ...
                var userIdGroupPairsContainer = container.nestedContainer(keyedBy: ClientRuntime.Key.self, forKey: ClientRuntime.Key("Groups"))
                try userIdGroupPairsContainer.encode("", forKey: ClientRuntime.Key(""))
            }
        }
    }
