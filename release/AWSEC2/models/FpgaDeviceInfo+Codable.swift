...
extension EC2ClientTypes.FpgaDeviceInfo: Swift.Codable {
    ...
    public init (from decoder: Swift.Decoder) throws {
        ...
        count = countDecoded
        let memoryInfoDecoded = try containerValues.decodeIfPresent(EC2ClientTypes.FpgaDeviceMemoryInfo.self, forKey: .memoryInfo)
