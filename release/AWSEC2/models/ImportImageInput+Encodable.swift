    ...
    public func encode(to encoder: Swift.Encoder) throws {
        ...
        if let diskContainers = diskContainers {
            if !diskContainers.isEmpty {
                ...
                var diskContainersContainer = container.nestedContainer(keyedBy: ClientRuntime.Key.self, forKey: ClientRuntime.Key("DiskContainer"))
                try diskContainersContainer.encode("", forKey: ClientRuntime.Key(""))
            }
        }
