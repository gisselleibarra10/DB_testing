    ...
    public func encode(to encoder: Swift.Encoder) throws {
        ...
        if let capacityAllocations = capacityAllocations {
            if !capacityAllocations.isEmpty {
                ...
                var capacityAllocationsContainer = container.nestedContainer(keyedBy: ClientRuntime.Key.self, forKey: ClientRuntime.Key("CapacityAllocationSet"))
                try capacityAllocationsContainer.encode("", forKey: ClientRuntime.Key(""))
            }
        }
