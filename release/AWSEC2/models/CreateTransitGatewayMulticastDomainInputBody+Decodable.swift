...
struct CreateTransitGatewayMulticastDomainInputBody: Swift.Equatable {
    let transitGatewayId: Swift.String?
    let options: EC2ClientTypes.CreateTransitGatewayMulticastDomainRequestOptions?
    let tagSpecifications: [EC2ClientTypes.TagSpecification]?
    let dryRun: Swift.Bool?
}

extension CreateTransitGatewayMulticastDomainInputBody: Swift.Decodable {
    ...
    public init (from decoder: Swift.Decoder) throws {
        ...
        let optionsDecoded = try containerValues.decodeIfPresent(EC2ClientTypes.CreateTransitGatewayMulticastDomainRequestOptions.self, forKey: .options)
