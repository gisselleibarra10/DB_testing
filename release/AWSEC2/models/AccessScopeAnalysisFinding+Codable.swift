    ...
    public func encode(to encoder: Swift.Encoder) throws {
        ...
        if let findingComponents = findingComponents {
            if !findingComponents.isEmpty {
                ...
                var findingComponentsContainer = container.nestedContainer(keyedBy: ClientRuntime.Key.self, forKey: ClientRuntime.Key("FindingComponentSet"))
                try findingComponentsContainer.encode("", forKey: ClientRuntime.Key(""))
            }
        }
