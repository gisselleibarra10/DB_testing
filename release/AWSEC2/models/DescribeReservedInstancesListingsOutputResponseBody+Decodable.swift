...
struct DescribeReservedInstancesListingsOutputResponseBody: Swift.Equatable {
    let reservedInstancesListings: [Ec2ClientTypes.ReservedInstancesListing]?
}

extension DescribeReservedInstancesListingsOutputResponseBody: Swift.Decodable {
