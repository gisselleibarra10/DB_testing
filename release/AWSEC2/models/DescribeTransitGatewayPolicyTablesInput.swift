...
public struct DescribeTransitGatewayPolicyTablesInput: Swift.Equatable {
    ...
    public var transitGatewayPolicyTableIds: [Swift.String]?
    ...
    public init (
        ...
        transitGatewayPolicyTableIds: [Swift.String]? = nil
    )
    {
        self.dryRun = dryRun
