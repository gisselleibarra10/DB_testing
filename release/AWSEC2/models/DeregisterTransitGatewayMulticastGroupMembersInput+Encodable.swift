...
extension DeregisterTransitGatewayMulticastGroupMembersInput: Swift.Encodable {
    public func encode(to encoder: Swift.Encoder) throws {
        ...
        if let networkInterfaceIds = networkInterfaceIds {
            if !networkInterfaceIds.isEmpty {
                ...
                var networkInterfaceIdsContainer = container.nestedContainer(keyedBy: ClientRuntime.Key.self, forKey: ClientRuntime.Key("NetworkInterfaceIds"))
        ...
        try container.encode("DeregisterTransitGatewayMulticastGroupMembers", forKey:ClientRuntime.Key("Action"))
