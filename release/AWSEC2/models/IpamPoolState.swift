...
extension EC2ClientTypes {
    public enum IpamPoolState: Swift.Equatable, Swift.RawRepresentable, Swift.CaseIterable, Swift.Codable, Swift.Hashable {
        case createComplete
        case createFailed
        ...
        public static var allCases: [IpamPoolState] {
            return [
                .createComplete,
                .createFailed,
                .createInProgress,
        ...
        public init(from decoder: Swift.Decoder) throws {
            ...
            self = IpamPoolState(rawValue: rawValue) ?? IpamPoolState.sdkUnknown(rawValue)
        }
    }
}
