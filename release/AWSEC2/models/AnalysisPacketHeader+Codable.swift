    ...
    public func encode(to encoder: Swift.Encoder) throws {
        ...
        if let destinationPortRanges = destinationPortRanges {
            if !destinationPortRanges.isEmpty {
                ...
                var destinationPortRangesContainer = container.nestedContainer(keyedBy: ClientRuntime.Key.self, forKey: ClientRuntime.Key("DestinationPortRangeSet"))
                try destinationPortRangesContainer.encode("", forKey: ClientRuntime.Key(""))
            }
        }
        ...
        if let sourcePortRanges = sourcePortRanges {
            if !sourcePortRanges.isEmpty {
                ...
                var sourcePortRangesContainer = container.nestedContainer(keyedBy: ClientRuntime.Key.self, forKey: ClientRuntime.Key("SourcePortRangeSet"))
                try sourcePortRangesContainer.encode("", forKey: ClientRuntime.Key(""))
            }
        }
    }
