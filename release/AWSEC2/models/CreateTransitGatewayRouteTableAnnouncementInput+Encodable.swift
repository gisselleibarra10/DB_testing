...
extension CreateTransitGatewayRouteTableAnnouncementInput: Swift.Encodable {
    public func encode(to encoder: Swift.Encoder) throws {
        ...
        try container.encode("CreateTransitGatewayRouteTableAnnouncement", forKey:ClientRuntime.Key("Action"))
