    ...
    public func encode(to encoder: Swift.Encoder) throws {
        ...
        if let egressFilterRules = egressFilterRules {
            if !egressFilterRules.isEmpty {
                ...
                var egressFilterRulesContainer = container.nestedContainer(keyedBy: ClientRuntime.Key.self, forKey: ClientRuntime.Key("EgressFilterRuleSet"))
                try egressFilterRulesContainer.encode("", forKey: ClientRuntime.Key(""))
            }
        }
        if let ingressFilterRules = ingressFilterRules {
            if !ingressFilterRules.isEmpty {
                ...
                var ingressFilterRulesContainer = container.nestedContainer(keyedBy: ClientRuntime.Key.self, forKey: ClientRuntime.Key("IngressFilterRuleSet"))
                try ingressFilterRulesContainer.encode("", forKey: ClientRuntime.Key(""))
            }
        }
        if let networkServices = networkServices {
            if !networkServices.isEmpty {
                ...
                var networkServicesContainer = container.nestedContainer(keyedBy: ClientRuntime.Key.self, forKey: ClientRuntime.Key("NetworkServiceSet"))
                try networkServicesContainer.encode("", forKey: ClientRuntime.Key(""))
            }
        }
        if let tags = tags {
            if !tags.isEmpty {
