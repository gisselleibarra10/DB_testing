    ...
    public func encode(to encoder: Swift.Encoder) throws {
        ...
        if let resourceTypes = resourceTypes {
            if !resourceTypes.isEmpty {
                ...
                var resourceTypesContainer = container.nestedContainer(keyedBy: ClientRuntime.Key.self, forKey: ClientRuntime.Key("ResourceTypeSet"))
        ...
        if let resources = resources {
            if !resources.isEmpty {
                ...
                var resourcesContainer = container.nestedContainer(keyedBy: ClientRuntime.Key.self, forKey: ClientRuntime.Key("ResourceSet"))
