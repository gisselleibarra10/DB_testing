...
extension GetTransitGatewayPolicyTableAssociationsInput: Swift.Encodable {
    public func encode(to encoder: Swift.Encoder) throws {
        ...
        try container.encode("GetTransitGatewayPolicyTableAssociations", forKey:ClientRuntime.Key("Action"))
