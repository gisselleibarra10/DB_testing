    ...
    public func encode(to encoder: Swift.Encoder) throws {
        ...
        if let disallowedCidrs = disallowedCidrs {
            if !disallowedCidrs.isEmpty {
                ...
                var disallowedCidrsContainer = container.nestedContainer(keyedBy: ClientRuntime.Key.self, forKey: ClientRuntime.Key("DisallowedCidr"))
                try disallowedCidrsContainer.encode("", forKey: ClientRuntime.Key(""))
            }
        }
