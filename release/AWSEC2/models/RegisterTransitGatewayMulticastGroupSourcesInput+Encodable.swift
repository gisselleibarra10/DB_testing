...
extension RegisterTransitGatewayMulticastGroupSourcesInput: Swift.Encodable {
    public func encode(to encoder: Swift.Encoder) throws {
        ...
        try container.encode("RegisterTransitGatewayMulticastGroupSources", forKey:ClientRuntime.Key("Action"))
