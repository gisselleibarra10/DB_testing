...
extension UnassignPrivateIpAddressesInput: Swift.Encodable {
    public func encode(to encoder: Swift.Encoder) throws {
        ...
        if let privateIpAddresses = privateIpAddresses {
            if !privateIpAddresses.isEmpty {
                ...
                var privateIpAddressesContainer = container.nestedContainer(keyedBy: ClientRuntime.Key.self, forKey: ClientRuntime.Key("PrivateIpAddress"))
                try privateIpAddressesContainer.encode("", forKey: ClientRuntime.Key(""))
            }
        }
        try container.encode("UnassignPrivateIpAddresses", forKey:ClientRuntime.Key("Action"))
