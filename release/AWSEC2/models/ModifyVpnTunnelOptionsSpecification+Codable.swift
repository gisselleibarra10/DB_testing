...
extension EC2ClientTypes.ModifyVpnTunnelOptionsSpecification: Swift.Codable {
    ...
    public func encode(to encoder: Swift.Encoder) throws {
        ...
        if let ikeVersions = ikeVersions {
            if !ikeVersions.isEmpty {
                ...
                var ikeVersionsContainer = container.nestedContainer(keyedBy: ClientRuntime.Key.self, forKey: ClientRuntime.Key("IKEVersion"))
                try ikeVersionsContainer.encode("", forKey: ClientRuntime.Key(""))
            }
        }
        ...
        if let phase1DHGroupNumbers = phase1DHGroupNumbers {
            if !phase1DHGroupNumbers.isEmpty {
                ...
                var phase1DHGroupNumbersContainer = container.nestedContainer(keyedBy: ClientRuntime.Key.self, forKey: ClientRuntime.Key("Phase1DHGroupNumber"))
                try phase1DHGroupNumbersContainer.encode("", forKey: ClientRuntime.Key(""))
            }
        }
        if let phase1EncryptionAlgorithms = phase1EncryptionAlgorithms {
            if !phase1EncryptionAlgorithms.isEmpty {
                ...
                var phase1EncryptionAlgorithmsContainer = container.nestedContainer(keyedBy: ClientRuntime.Key.self, forKey: ClientRuntime.Key("Phase1EncryptionAlgorithm"))
                try phase1EncryptionAlgorithmsContainer.encode("", forKey: ClientRuntime.Key(""))
            }
        }
        if let phase1IntegrityAlgorithms = phase1IntegrityAlgorithms {
            if !phase1IntegrityAlgorithms.isEmpty {
                ...
                var phase1IntegrityAlgorithmsContainer = container.nestedContainer(keyedBy: ClientRuntime.Key.self, forKey: ClientRuntime.Key("Phase1IntegrityAlgorithm"))
                try phase1IntegrityAlgorithmsContainer.encode("", forKey: ClientRuntime.Key(""))
            }
        }
        ...
        if let phase2DHGroupNumbers = phase2DHGroupNumbers {
            if !phase2DHGroupNumbers.isEmpty {
                ...
                var phase2DHGroupNumbersContainer = container.nestedContainer(keyedBy: ClientRuntime.Key.self, forKey: ClientRuntime.Key("Phase2DHGroupNumber"))
                try phase2DHGroupNumbersContainer.encode("", forKey: ClientRuntime.Key(""))
            }
        }
        if let phase2EncryptionAlgorithms = phase2EncryptionAlgorithms {
            if !phase2EncryptionAlgorithms.isEmpty {
                ...
                var phase2EncryptionAlgorithmsContainer = container.nestedContainer(keyedBy: ClientRuntime.Key.self, forKey: ClientRuntime.Key("Phase2EncryptionAlgorithm"))
                try phase2EncryptionAlgorithmsContainer.encode("", forKey: ClientRuntime.Key(""))
            }
        }
        if let phase2IntegrityAlgorithms = phase2IntegrityAlgorithms {
            if !phase2IntegrityAlgorithms.isEmpty {
                ...
                var phase2IntegrityAlgorithmsContainer = container.nestedContainer(keyedBy: ClientRuntime.Key.self, forKey: ClientRuntime.Key("Phase2IntegrityAlgorithm"))
                try phase2IntegrityAlgorithmsContainer.encode("", forKey: ClientRuntime.Key(""))
            }
        }
