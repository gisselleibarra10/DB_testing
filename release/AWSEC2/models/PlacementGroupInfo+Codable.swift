    ...
    public func encode(to encoder: Swift.Encoder) throws {
        ...
        if let supportedStrategies = supportedStrategies {
            if !supportedStrategies.isEmpty {
                ...
                var supportedStrategiesContainer = container.nestedContainer(keyedBy: ClientRuntime.Key.self, forKey: ClientRuntime.Key("SupportedStrategies"))
                try supportedStrategiesContainer.encode("", forKey: ClientRuntime.Key(""))
            }
        }
    }
