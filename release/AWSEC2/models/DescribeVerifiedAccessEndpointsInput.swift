...
public struct DescribeVerifiedAccessEndpointsInput: Swift.Equatable {
    ...
    public var verifiedAccessEndpointIds: [Swift.String]?
    ...
    public init (
        ...
        verifiedAccessEndpointIds: [Swift.String]? = nil,
