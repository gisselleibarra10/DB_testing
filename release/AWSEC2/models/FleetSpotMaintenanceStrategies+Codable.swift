...
extension EC2ClientTypes.FleetSpotMaintenanceStrategies: Swift.Codable {
    ...
    public init (from decoder: Swift.Decoder) throws {
        ...
        let capacityRebalanceDecoded = try containerValues.decodeIfPresent(EC2ClientTypes.FleetSpotCapacityRebalance.self, forKey: .capacityRebalance)
