...
extension ModifyTransitGatewayPrefixListReferenceInput: Swift.Encodable {
    public func encode(to encoder: Swift.Encoder) throws {
        ...
        try container.encode("ModifyTransitGatewayPrefixListReference", forKey:ClientRuntime.Key("Action"))
