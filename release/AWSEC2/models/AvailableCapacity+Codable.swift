    ...
    public func encode(to encoder: Swift.Encoder) throws {
        ...
        if let availableInstanceCapacity = availableInstanceCapacity {
            if !availableInstanceCapacity.isEmpty {
                ...
                var availableInstanceCapacityContainer = container.nestedContainer(keyedBy: ClientRuntime.Key.self, forKey: ClientRuntime.Key("AvailableInstanceCapacity"))
                try availableInstanceCapacityContainer.encode("", forKey: ClientRuntime.Key(""))
            }
        }
