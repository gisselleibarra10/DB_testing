    ...
    public func encode(to encoder: Swift.Encoder) throws {
        ...
        if let volumes = volumes {
            if !volumes.isEmpty {
                ...
                var volumesContainer = container.nestedContainer(keyedBy: ClientRuntime.Key.self, forKey: ClientRuntime.Key("Volumes"))
                try volumesContainer.encode("", forKey: ClientRuntime.Key(""))
            }
        }
    }
