...
extension CreateVerifiedAccessTrustProviderInput: Swift.Encodable {
    public func encode(to encoder: Swift.Encoder) throws {
        ...
        try container.encode("CreateVerifiedAccessTrustProvider", forKey:ClientRuntime.Key("Action"))
