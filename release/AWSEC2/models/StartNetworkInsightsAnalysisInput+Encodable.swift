    ...
    public func encode(to encoder: Swift.Encoder) throws {
        ...
        if let additionalAccounts = additionalAccounts {
            if !additionalAccounts.isEmpty {
                for (index0, string0) in additionalAccounts.enumerated() {
                    var additionalAccountsContainer0 = container.nestedContainer(keyedBy: ClientRuntime.Key.self, forKey: ClientRuntime.Key("AdditionalAccount.\(index0.advanced(by: 1))"))
                    try additionalAccountsContainer0.encode(string0, forKey: ClientRuntime.Key(""))
                }
            }
            else {
                var additionalAccountsContainer = container.nestedContainer(keyedBy: ClientRuntime.Key.self, forKey: ClientRuntime.Key("AdditionalAccount"))
        ...
        if let filterInArns = filterInArns {
            if !filterInArns.isEmpty {
                ...
                var filterInArnsContainer = container.nestedContainer(keyedBy: ClientRuntime.Key.self, forKey: ClientRuntime.Key("FilterInArn"))
