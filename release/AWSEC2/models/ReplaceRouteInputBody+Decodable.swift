...
struct ReplaceRouteInputBody: Swift.Equatable {
...
extension ReplaceRouteInputBody: Swift.Decodable {
    ...
    public init (from decoder: Swift.Decoder) throws {
        ...
        let localTargetDecoded = try containerValues.decodeIfPresent(Swift.Bool.self, forKey: .localTarget)
        localTarget = localTargetDecoded
