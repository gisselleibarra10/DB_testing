    ...
    public func encode(to encoder: Swift.Encoder) throws {
        ...
        if let customDnsServers = customDnsServers {
            if !customDnsServers.isEmpty {
                ...
                var customDnsServersContainer = container.nestedContainer(keyedBy: ClientRuntime.Key.self, forKey: ClientRuntime.Key("CustomDnsServers"))
                try customDnsServersContainer.encode("", forKey: ClientRuntime.Key(""))
            }
        }
