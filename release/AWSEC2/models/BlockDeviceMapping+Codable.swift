...
extension EC2ClientTypes.BlockDeviceMapping: Swift.Codable {
    ...
    public init (from decoder: Swift.Decoder) throws {
        ...
        let ebsDecoded = try containerValues.decodeIfPresent(EC2ClientTypes.EbsBlockDevice.self, forKey: .ebs)
        ebs = ebsDecoded
