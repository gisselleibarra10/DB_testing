...
extension DisableTransitGatewayRouteTablePropagationInput: Swift.Encodable {
    public func encode(to encoder: Swift.Encoder) throws {
        ...
        try container.encode("DisableTransitGatewayRouteTablePropagation", forKey:ClientRuntime.Key("Action"))
