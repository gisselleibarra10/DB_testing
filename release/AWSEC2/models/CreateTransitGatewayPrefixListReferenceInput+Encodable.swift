...
extension CreateTransitGatewayPrefixListReferenceInput: Swift.Encodable {
    public func encode(to encoder: Swift.Encoder) throws {
        ...
        try container.encode("CreateTransitGatewayPrefixListReference", forKey:ClientRuntime.Key("Action"))
