...
extension ReplaceIamInstanceProfileAssociationInput: Swift.Encodable {
    public func encode(to encoder: Swift.Encoder) throws {
        ...
        try container.encode("ReplaceIamInstanceProfileAssociation", forKey:ClientRuntime.Key("Action"))
