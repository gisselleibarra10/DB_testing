...
extension GetTransitGatewayMulticastDomainAssociationsInput: Swift.Encodable {
    public func encode(to encoder: Swift.Encoder) throws {
        ...
        try container.encode("GetTransitGatewayMulticastDomainAssociations", forKey:ClientRuntime.Key("Action"))
