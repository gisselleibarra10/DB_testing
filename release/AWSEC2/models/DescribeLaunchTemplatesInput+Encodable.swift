    ...
    public func encode(to encoder: Swift.Encoder) throws {
        ...
        if let launchTemplateIds = launchTemplateIds {
            if !launchTemplateIds.isEmpty {
                ...
                var launchTemplateIdsContainer = container.nestedContainer(keyedBy: ClientRuntime.Key.self, forKey: ClientRuntime.Key("LaunchTemplateId"))
                try launchTemplateIdsContainer.encode("", forKey: ClientRuntime.Key(""))
            }
        }
        if let launchTemplateNames = launchTemplateNames {
            if !launchTemplateNames.isEmpty {
                ...
                var launchTemplateNamesContainer = container.nestedContainer(keyedBy: ClientRuntime.Key.self, forKey: ClientRuntime.Key("LaunchTemplateName"))
                try launchTemplateNamesContainer.encode("", forKey: ClientRuntime.Key(""))
            }
        }
