    ...
    public func encode(to encoder: Swift.Encoder) throws {
        ...
        if let executableUsers = executableUsers {
            if !executableUsers.isEmpty {
                ...
                var executableUsersContainer = container.nestedContainer(keyedBy: ClientRuntime.Key.self, forKey: ClientRuntime.Key("ExecutableBy"))
                try executableUsersContainer.encode("", forKey: ClientRuntime.Key(""))
            }
        }
