...
extension EC2ClientTypes.ScheduledInstanceAvailability: Swift.Codable {
    ...
    public func encode(to encoder: Swift.Encoder) throws {
        ...
        if let firstSlotStartTime = firstSlotStartTime {
            try container.encodeTimestamp(firstSlotStartTime, format: .dateTime, forKey: ClientRuntime.Key("FirstSlotStartTime"))
        }
    ...
    public init (from decoder: Swift.Decoder) throws {
        ...
        let firstSlotStartTimeDecoded = try containerValues.decodeTimestampIfPresent(.dateTime, forKey: .firstSlotStartTime)
        firstSlotStartTime = firstSlotStartTimeDecoded
