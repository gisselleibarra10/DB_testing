...
extension DeleteTransitGatewayVpcAttachmentInput: Swift.Encodable {
    public func encode(to encoder: Swift.Encoder) throws {
        ...
        try container.encode("DeleteTransitGatewayVpcAttachment", forKey:ClientRuntime.Key("Action"))
