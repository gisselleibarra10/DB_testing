...
extension Ec2ClientTypes.LaunchTemplateBlockDeviceMappingRequest: Swift.Codable {
    ...
    public init (from decoder: Swift.Decoder) throws {
        ...
        let ebsDecoded = try containerValues.decodeIfPresent(Ec2ClientTypes.LaunchTemplateEbsBlockDeviceRequest.self, forKey: .ebs)
        ebs = ebsDecoded
