    ...
    public func encode(to encoder: Swift.Encoder) throws {
        ...
        if let organizationArns = organizationArns {
            if !organizationArns.isEmpty {
                ...
                var organizationArnsContainer = container.nestedContainer(keyedBy: ClientRuntime.Key.self, forKey: ClientRuntime.Key("OrganizationArn"))
                try organizationArnsContainer.encode("", forKey: ClientRuntime.Key(""))
            }
        }
        if let organizationalUnitArns = organizationalUnitArns {
            if !organizationalUnitArns.isEmpty {
                ...
                var organizationalUnitArnsContainer = container.nestedContainer(keyedBy: ClientRuntime.Key.self, forKey: ClientRuntime.Key("OrganizationalUnitArn"))
                try organizationalUnitArnsContainer.encode("", forKey: ClientRuntime.Key(""))
            }
        }
