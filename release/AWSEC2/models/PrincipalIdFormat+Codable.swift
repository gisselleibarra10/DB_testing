    ...
    public func encode(to encoder: Swift.Encoder) throws {
        ...
        if let statuses = statuses {
            if !statuses.isEmpty {
                ...
                var statusesContainer = container.nestedContainer(keyedBy: ClientRuntime.Key.self, forKey: ClientRuntime.Key("StatusSet"))
                try statusesContainer.encode("", forKey: ClientRuntime.Key(""))
            }
        }
    }
