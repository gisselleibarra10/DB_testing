...
extension DescribeIpamsInput: Swift.Encodable {
    public func encode(to encoder: Swift.Encoder) throws {
        ...
        if let ipamIds = ipamIds {
            if !ipamIds.isEmpty {
                for (index0, string0) in ipamIds.enumerated() {
                    var ipamIdsContainer0 = container.nestedContainer(keyedBy: ClientRuntime.Key.self, forKey: ClientRuntime.Key("IpamId.\(index0.advanced(by: 1))"))
                    try ipamIdsContainer0.encode(string0, forKey: ClientRuntime.Key(""))
                }
            }
            else {
                var ipamIdsContainer = container.nestedContainer(keyedBy: ClientRuntime.Key.self, forKey: ClientRuntime.Key("IpamId"))
                try ipamIdsContainer.encode("", forKey: ClientRuntime.Key(""))
            }
        }
        ...
        try container.encode("DescribeIpams", forKey:ClientRuntime.Key("Action"))
