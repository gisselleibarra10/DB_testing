...
extension Ec2ClientTypes.SpotOptionsRequest: Swift.Codable {
    ...
    public init (from decoder: Swift.Decoder) throws {
        ...
        let maintenanceStrategiesDecoded = try containerValues.decodeIfPresent(Ec2ClientTypes.FleetSpotMaintenanceStrategiesRequest.self, forKey: .maintenanceStrategies)
