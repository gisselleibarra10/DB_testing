    ...
    public func encode(to encoder: Swift.Encoder) throws {
        ...
        if let athenaIntegrations = athenaIntegrations {
            if !athenaIntegrations.isEmpty {
                ...
                var athenaIntegrationsContainer = container.nestedContainer(keyedBy: ClientRuntime.Key.self, forKey: ClientRuntime.Key("AthenaIntegration"))
                try athenaIntegrationsContainer.encode("", forKey: ClientRuntime.Key(""))
            }
        }
    }
