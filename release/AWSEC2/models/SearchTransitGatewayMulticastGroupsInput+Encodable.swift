...
extension SearchTransitGatewayMulticastGroupsInput: Swift.Encodable {
    public func encode(to encoder: Swift.Encoder) throws {
        ...
        try container.encode("SearchTransitGatewayMulticastGroups", forKey:ClientRuntime.Key("Action"))
