    ...
    public func encode(to encoder: Swift.Encoder) throws {
        ...
        if let resourceTags = resourceTags {
            if !resourceTags.isEmpty {
                ...
                var resourceTagsContainer = container.nestedContainer(keyedBy: ClientRuntime.Key.self, forKey: ClientRuntime.Key("ResourceTagSet"))
                try resourceTagsContainer.encode("", forKey: ClientRuntime.Key(""))
            }
        }
