...
extension EC2ClientTypes.VgwTelemetry: Swift.Codable {
    ...
    public func encode(to encoder: Swift.Encoder) throws {
        ...
        if let lastStatusChange = lastStatusChange {
            try container.encodeTimestamp(lastStatusChange, format: .dateTime, forKey: ClientRuntime.Key("LastStatusChange"))
        }
    ...
    public init (from decoder: Swift.Decoder) throws {
        ...
        let lastStatusChangeDecoded = try containerValues.decodeTimestampIfPresent(.dateTime, forKey: .lastStatusChange)
