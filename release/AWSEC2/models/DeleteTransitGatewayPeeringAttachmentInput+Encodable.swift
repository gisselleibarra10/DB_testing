...
extension DeleteTransitGatewayPeeringAttachmentInput: Swift.Encodable {
    public func encode(to encoder: Swift.Encoder) throws {
        ...
        try container.encode("DeleteTransitGatewayPeeringAttachment", forKey:ClientRuntime.Key("Action"))
