...
extension DeleteLocalGatewayRouteTableVpcAssociationInput: Swift.Encodable {
    public func encode(to encoder: Swift.Encoder) throws {
        ...
        try container.encode("DeleteLocalGatewayRouteTableVpcAssociation", forKey:ClientRuntime.Key("Action"))
