...
extension CreateLocalGatewayRouteTableVpcAssociationInput: Swift.Encodable {
    public func encode(to encoder: Swift.Encoder) throws {
        ...
        try container.encode("CreateLocalGatewayRouteTableVpcAssociation", forKey:ClientRuntime.Key("Action"))
