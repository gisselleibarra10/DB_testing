    ...
    public func encode(to encoder: Swift.Encoder) throws {
        ...
        if let postureComplianceStatuses = postureComplianceStatuses {
            if !postureComplianceStatuses.isEmpty {
                ...
                var postureComplianceStatusesContainer = container.nestedContainer(keyedBy: ClientRuntime.Key.self, forKey: ClientRuntime.Key("PostureComplianceStatusSet"))
                try postureComplianceStatusesContainer.encode("", forKey: ClientRuntime.Key(""))
            }
        }
