    ...
    public func encode(to encoder: Swift.Encoder) throws {
        ...
        if let authenticationOptions = authenticationOptions {
            if !authenticationOptions.isEmpty {
                ...
                var authenticationOptionsContainer = container.nestedContainer(keyedBy: ClientRuntime.Key.self, forKey: ClientRuntime.Key("Authentication"))
        ...
        if let dnsServers = dnsServers {
            if !dnsServers.isEmpty {
                ...
                var dnsServersContainer = container.nestedContainer(keyedBy: ClientRuntime.Key.self, forKey: ClientRuntime.Key("DnsServers"))
