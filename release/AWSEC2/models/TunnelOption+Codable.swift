    ...
    public func encode(to encoder: Swift.Encoder) throws {
        ...
        if let ikeVersions = ikeVersions {
            if !ikeVersions.isEmpty {
                ...
                var ikeVersionsContainer = container.nestedContainer(keyedBy: ClientRuntime.Key.self, forKey: ClientRuntime.Key("IkeVersionSet"))
        ...
        if let phase1DHGroupNumbers = phase1DHGroupNumbers {
            if !phase1DHGroupNumbers.isEmpty {
                ...
                var phase1DHGroupNumbersContainer = container.nestedContainer(keyedBy: ClientRuntime.Key.self, forKey: ClientRuntime.Key("Phase1DHGroupNumberSet"))
        ...
        if let phase1EncryptionAlgorithms = phase1EncryptionAlgorithms {
            if !phase1EncryptionAlgorithms.isEmpty {
                ...
                var phase1EncryptionAlgorithmsContainer = container.nestedContainer(keyedBy: ClientRuntime.Key.self, forKey: ClientRuntime.Key("Phase1EncryptionAlgorithmSet"))
        ...
        if let phase1IntegrityAlgorithms = phase1IntegrityAlgorithms {
            if !phase1IntegrityAlgorithms.isEmpty {
                ...
                var phase1IntegrityAlgorithmsContainer = container.nestedContainer(keyedBy: ClientRuntime.Key.self, forKey: ClientRuntime.Key("Phase1IntegrityAlgorithmSet"))
        ...
        if let phase2DHGroupNumbers = phase2DHGroupNumbers {
            if !phase2DHGroupNumbers.isEmpty {
                ...
                var phase2DHGroupNumbersContainer = container.nestedContainer(keyedBy: ClientRuntime.Key.self, forKey: ClientRuntime.Key("Phase2DHGroupNumberSet"))
        ...
        if let phase2EncryptionAlgorithms = phase2EncryptionAlgorithms {
            if !phase2EncryptionAlgorithms.isEmpty {
                ...
                var phase2EncryptionAlgorithmsContainer = container.nestedContainer(keyedBy: ClientRuntime.Key.self, forKey: ClientRuntime.Key("Phase2EncryptionAlgorithmSet"))
        ...
        if let phase2IntegrityAlgorithms = phase2IntegrityAlgorithms {
            if !phase2IntegrityAlgorithms.isEmpty {
                ...
                var phase2IntegrityAlgorithmsContainer = container.nestedContainer(keyedBy: ClientRuntime.Key.self, forKey: ClientRuntime.Key("Phase2IntegrityAlgorithmSet"))
