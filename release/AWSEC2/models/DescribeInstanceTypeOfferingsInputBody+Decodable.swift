...
struct DescribeInstanceTypeOfferingsInputBody: Swift.Equatable {
    let dryRun: Swift.Bool?
    let locationType: EC2ClientTypes.LocationType?
    let filters: [EC2ClientTypes.Filter]?
    let maxResults: Swift.Int?
    let nextToken: Swift.String?
}

extension DescribeInstanceTypeOfferingsInputBody: Swift.Decodable {
