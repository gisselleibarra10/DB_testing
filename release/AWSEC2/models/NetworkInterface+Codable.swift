...
extension EC2ClientTypes.NetworkInterface: Swift.Codable {
    ...
    public func encode(to encoder: Swift.Encoder) throws {
        ...
        if let denyAllIgwTraffic = denyAllIgwTraffic {
            try container.encode(denyAllIgwTraffic, forKey: ClientRuntime.Key("DenyAllIgwTraffic"))
        }
        ...
        if let ipv4Prefixes = ipv4Prefixes {
            if !ipv4Prefixes.isEmpty {
                for (index0, ipv4prefixspecification0) in ipv4Prefixes.enumerated() {
                    ...
                    try ipv4PrefixesContainer0.encode(ipv4prefixspecification0, forKey: ClientRuntime.Key(""))
                }
            }
            else {
        ...
        if let ipv6Addresses = ipv6Addresses {
            if !ipv6Addresses.isEmpty {
                for (index0, networkinterfaceipv6address0) in ipv6Addresses.enumerated() {
                    ...
                    try ipv6AddressesContainer0.encode(networkinterfaceipv6address0, forKey: ClientRuntime.Key(""))
                }
            }
            else {
        ...
        if let ipv6Prefixes = ipv6Prefixes {
            if !ipv6Prefixes.isEmpty {
                for (index0, ipv6prefixspecification0) in ipv6Prefixes.enumerated() {
                    ...
                    try ipv6PrefixesContainer0.encode(ipv6prefixspecification0, forKey: ClientRuntime.Key(""))
                }
            }
            else {
        ...
        if let privateIpAddresses = privateIpAddresses {
            if !privateIpAddresses.isEmpty {
                for (index0, networkinterfaceprivateipaddress0) in privateIpAddresses.enumerated() {
                    ...
                    try privateIpAddressesContainer0.encode(networkinterfaceprivateipaddress0, forKey: ClientRuntime.Key(""))
                }
            }
            else {
        ...
        if let tagSet = tagSet {
            if !tagSet.isEmpty {
                for (index0, tag0) in tagSet.enumerated() {
                    var tagSetContainer0 = container.nestedContainer(keyedBy: ClientRuntime.Key.self, forKey: ClientRuntime.Key("TagSet.\(index0.advanced(by: 1))"))
                    try tagSetContainer0.encode(tag0, forKey: ClientRuntime.Key(""))
                }
            }
            else {
                var tagSetContainer = container.nestedContainer(keyedBy: ClientRuntime.Key.self, forKey: ClientRuntime.Key("TagSet"))
                try tagSetContainer.encode("", forKey: ClientRuntime.Key(""))
            }
        }
        if let vpcId = vpcId {
    ...
    public init (from decoder: Swift.Decoder) throws {
        ...
        let interfaceTypeDecoded = try containerValues.decodeIfPresent(EC2ClientTypes.NetworkInterfaceType.self, forKey: .interfaceType)
        ...
        if containerValues.contains(.ipv6Addresses) {
            ...
            if let ipv6AddressesWrappedContainer = ipv6AddressesWrappedContainer {
                let ipv6AddressesContainer = try ipv6AddressesWrappedContainer.decodeIfPresent([EC2ClientTypes.NetworkInterfaceIpv6Address].self, forKey: .member)
                var ipv6AddressesBuffer:[EC2ClientTypes.NetworkInterfaceIpv6Address]? = nil
                if let ipv6AddressesContainer = ipv6AddressesContainer {
                    ipv6AddressesBuffer = [EC2ClientTypes.NetworkInterfaceIpv6Address]()
        ...
        if containerValues.contains(.privateIpAddresses) {
            ...
            if let privateIpAddressesWrappedContainer = privateIpAddressesWrappedContainer {
                let privateIpAddressesContainer = try privateIpAddressesWrappedContainer.decodeIfPresent([EC2ClientTypes.NetworkInterfacePrivateIpAddress].self, forKey: .member)
                var privateIpAddressesBuffer:[EC2ClientTypes.NetworkInterfacePrivateIpAddress]? = nil
                if let privateIpAddressesContainer = privateIpAddressesContainer {
                    privateIpAddressesBuffer = [EC2ClientTypes.NetworkInterfacePrivateIpAddress]()
        ...
        if containerValues.contains(.ipv4Prefixes) {
            ...
            if let ipv4PrefixesWrappedContainer = ipv4PrefixesWrappedContainer {
                let ipv4PrefixesContainer = try ipv4PrefixesWrappedContainer.decodeIfPresent([EC2ClientTypes.Ipv4PrefixSpecification].self, forKey: .member)
                var ipv4PrefixesBuffer:[EC2ClientTypes.Ipv4PrefixSpecification]? = nil
                if let ipv4PrefixesContainer = ipv4PrefixesContainer {
                    ipv4PrefixesBuffer = [EC2ClientTypes.Ipv4PrefixSpecification]()
        ...
        if containerValues.contains(.ipv6Prefixes) {
            ...
            if let ipv6PrefixesWrappedContainer = ipv6PrefixesWrappedContainer {
                let ipv6PrefixesContainer = try ipv6PrefixesWrappedContainer.decodeIfPresent([EC2ClientTypes.Ipv6PrefixSpecification].self, forKey: .member)
                var ipv6PrefixesBuffer:[EC2ClientTypes.Ipv6PrefixSpecification]? = nil
                if let ipv6PrefixesContainer = ipv6PrefixesContainer {
                    ipv6PrefixesBuffer = [EC2ClientTypes.Ipv6PrefixSpecification]()
        ...
        if containerValues.contains(.tagSet) {
            ...
            if let tagSetWrappedContainer = tagSetWrappedContainer {
                let tagSetContainer = try tagSetWrappedContainer.decodeIfPresent([EC2ClientTypes.Tag].self, forKey: .member)
                var tagSetBuffer:[EC2ClientTypes.Tag]? = nil
                if let tagSetContainer = tagSetContainer {
                    tagSetBuffer = [EC2ClientTypes.Tag]()
        ...
        vpcId = vpcIdDecoded
        let denyAllIgwTrafficDecoded = try containerValues.decodeIfPresent(Swift.Bool.self, forKey: .denyAllIgwTraffic)
        denyAllIgwTraffic = denyAllIgwTrafficDecoded
