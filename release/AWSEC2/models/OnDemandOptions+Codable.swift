...
extension Ec2ClientTypes.OnDemandOptions: Swift.Codable {
    ...
    public init (from decoder: Swift.Decoder) throws {
        ...
        let capacityReservationOptionsDecoded = try containerValues.decodeIfPresent(Ec2ClientTypes.CapacityReservationOptions.self, forKey: .capacityReservationOptions)
