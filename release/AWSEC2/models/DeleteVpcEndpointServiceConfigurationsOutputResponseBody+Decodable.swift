...
struct DeleteVpcEndpointServiceConfigurationsOutputResponseBody: Swift.Equatable {
    let unsuccessful: [EC2ClientTypes.UnsuccessfulItem]?
}

extension DeleteVpcEndpointServiceConfigurationsOutputResponseBody: Swift.Decodable {
