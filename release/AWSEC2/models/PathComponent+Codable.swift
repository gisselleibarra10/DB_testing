    ...
    public func encode(to encoder: Swift.Encoder) throws {
        ...
        if let additionalDetails = additionalDetails {
            if !additionalDetails.isEmpty {
                ...
                var additionalDetailsContainer = container.nestedContainer(keyedBy: ClientRuntime.Key.self, forKey: ClientRuntime.Key("AdditionalDetailSet"))
                try additionalDetailsContainer.encode("", forKey: ClientRuntime.Key(""))
            }
        }
