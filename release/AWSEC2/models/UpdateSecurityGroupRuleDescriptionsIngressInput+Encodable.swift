...
extension UpdateSecurityGroupRuleDescriptionsIngressInput: Swift.Encodable {
    public func encode(to encoder: Swift.Encoder) throws {
        ...
        try container.encode("UpdateSecurityGroupRuleDescriptionsIngress", forKey:ClientRuntime.Key("Action"))
