...
struct DescribeInstanceStatusInputBody: Swift.Equatable {
    let filters: [Ec2ClientTypes.Filter]?
    let instanceIds: [Swift.String]?
    let maxResults: Swift.Int?
    let nextToken: Swift.String?
    let dryRun: Swift.Bool?
    let includeAllInstances: Swift.Bool?
}

extension DescribeInstanceStatusInputBody: Swift.Decodable {
    ...
    public init (from decoder: Swift.Decoder) throws {
        ...
        let includeAllInstancesDecoded = try containerValues.decodeIfPresent(Swift.Bool.self, forKey: .includeAllInstances)
