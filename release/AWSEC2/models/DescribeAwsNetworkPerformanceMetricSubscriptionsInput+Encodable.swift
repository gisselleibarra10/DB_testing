...
extension DescribeAwsNetworkPerformanceMetricSubscriptionsInput: Swift.Encodable {
    public func encode(to encoder: Swift.Encoder) throws {
        ...
        try container.encode("DescribeAwsNetworkPerformanceMetricSubscriptions", forKey:ClientRuntime.Key("Action"))
