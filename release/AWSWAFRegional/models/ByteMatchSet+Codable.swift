...
extension WafRegionalClientTypes.ByteMatchSet: Swift.Codable {
    ...
    public init (from decoder: Swift.Decoder) throws {
        ...
        name = nameDecoded
        let byteMatchTuplesContainer = try containerValues.decodeIfPresent([WafRegionalClientTypes.ByteMatchTuple?].self, forKey: .byteMatchTuples)
        var byteMatchTuplesDecoded0:[WafRegionalClientTypes.ByteMatchTuple]? = nil
        if let byteMatchTuplesContainer = byteMatchTuplesContainer {
            byteMatchTuplesDecoded0 = [WafRegionalClientTypes.ByteMatchTuple]()
