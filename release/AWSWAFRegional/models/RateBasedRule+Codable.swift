...
extension WafRegionalClientTypes.RateBasedRule: Swift.Codable {
    ...
    public init (from decoder: Swift.Decoder) throws {
        ...
        let matchPredicatesContainer = try containerValues.decodeIfPresent([WafRegionalClientTypes.Predicate?].self, forKey: .matchPredicates)
        var matchPredicatesDecoded0:[WafRegionalClientTypes.Predicate]? = nil
        if let matchPredicatesContainer = matchPredicatesContainer {
            matchPredicatesDecoded0 = [WafRegionalClientTypes.Predicate]()
