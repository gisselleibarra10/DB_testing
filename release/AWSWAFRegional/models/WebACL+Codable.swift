...
extension WafRegionalClientTypes.WebACL: Swift.Codable {
    ...
    public init (from decoder: Swift.Decoder) throws {
        ...
        let rulesContainer = try containerValues.decodeIfPresent([WafRegionalClientTypes.ActivatedRule?].self, forKey: .rules)
        var rulesDecoded0:[WafRegionalClientTypes.ActivatedRule]? = nil
        if let rulesContainer = rulesContainer {
            rulesDecoded0 = [WafRegionalClientTypes.ActivatedRule]()
