...
extension WafRegionalClientTypes.ActivatedRule: Swift.Codable {
    ...
    public init (from decoder: Swift.Decoder) throws {
        ...
        let actionDecoded = try containerValues.decodeIfPresent(WafRegionalClientTypes.WafAction.self, forKey: .action)
        action = actionDecoded
        let overrideActionDecoded = try containerValues.decodeIfPresent(WafRegionalClientTypes.WafOverrideAction.self, forKey: .overrideAction)
        overrideAction = overrideActionDecoded
        let typeDecoded = try containerValues.decodeIfPresent(WafRegionalClientTypes.WafRuleType.self, forKey: .type)
        type = typeDecoded
        let excludedRulesContainer = try containerValues.decodeIfPresent([WafRegionalClientTypes.ExcludedRule?].self, forKey: .excludedRules)
        var excludedRulesDecoded0:[WafRegionalClientTypes.ExcludedRule]? = nil
        if let excludedRulesContainer = excludedRulesContainer {
            excludedRulesDecoded0 = [WafRegionalClientTypes.ExcludedRule]()
