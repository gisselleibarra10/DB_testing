...
struct UpdateSizeConstraintSetInputBody: Swift.Equatable {
    ...
    let updates: [WafRegionalClientTypes.SizeConstraintSetUpdate]?
}
...
extension UpdateSizeConstraintSetInputBody: Swift.Decodable {
    ...
    public init (from decoder: Swift.Decoder) throws {
        ...
        let updatesContainer = try containerValues.decodeIfPresent([WafRegionalClientTypes.SizeConstraintSetUpdate?].self, forKey: .updates)
        var updatesDecoded0:[WafRegionalClientTypes.SizeConstraintSetUpdate]? = nil
        if let updatesContainer = updatesContainer {
            updatesDecoded0 = [WafRegionalClientTypes.SizeConstraintSetUpdate]()
