...
struct UpdateRuleGroupInputBody: Swift.Equatable {
    ...
    let updates: [WafRegionalClientTypes.RuleGroupUpdate]?
...
extension UpdateRuleGroupInputBody: Swift.Decodable {
    ...
    public init (from decoder: Swift.Decoder) throws {
        ...
        let updatesContainer = try containerValues.decodeIfPresent([WafRegionalClientTypes.RuleGroupUpdate?].self, forKey: .updates)
        var updatesDecoded0:[WafRegionalClientTypes.RuleGroupUpdate]? = nil
        if let updatesContainer = updatesContainer {
            updatesDecoded0 = [WafRegionalClientTypes.RuleGroupUpdate]()
