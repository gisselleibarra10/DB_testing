...
extension WafRegionalClientTypes.SqlInjectionMatchSet: Swift.Codable {
    ...
    public init (from decoder: Swift.Decoder) throws {
        ...
        name = nameDecoded
        let sqlInjectionMatchTuplesContainer = try containerValues.decodeIfPresent([WafRegionalClientTypes.SqlInjectionMatchTuple?].self, forKey: .sqlInjectionMatchTuples)
        var sqlInjectionMatchTuplesDecoded0:[WafRegionalClientTypes.SqlInjectionMatchTuple]? = nil
        if let sqlInjectionMatchTuplesContainer = sqlInjectionMatchTuplesContainer {
            sqlInjectionMatchTuplesDecoded0 = [WafRegionalClientTypes.SqlInjectionMatchTuple]()
