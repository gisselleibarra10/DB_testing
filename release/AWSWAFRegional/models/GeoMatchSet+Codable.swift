...
extension WafRegionalClientTypes.GeoMatchSet: Swift.Codable {
    ...
    public init (from decoder: Swift.Decoder) throws {
        ...
        name = nameDecoded
        let geoMatchConstraintsContainer = try containerValues.decodeIfPresent([WafRegionalClientTypes.GeoMatchConstraint?].self, forKey: .geoMatchConstraints)
        var geoMatchConstraintsDecoded0:[WafRegionalClientTypes.GeoMatchConstraint]? = nil
        if let geoMatchConstraintsContainer = geoMatchConstraintsContainer {
            geoMatchConstraintsDecoded0 = [WafRegionalClientTypes.GeoMatchConstraint]()
