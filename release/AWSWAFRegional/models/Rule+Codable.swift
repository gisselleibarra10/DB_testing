...
extension WafRegionalClientTypes.Rule: Swift.Codable {
    ...
    public init (from decoder: Swift.Decoder) throws {
        ...
        let predicatesContainer = try containerValues.decodeIfPresent([WafRegionalClientTypes.Predicate?].self, forKey: .predicates)
        var predicatesDecoded0:[WafRegionalClientTypes.Predicate]? = nil
        if let predicatesContainer = predicatesContainer {
            predicatesDecoded0 = [WafRegionalClientTypes.Predicate]()
