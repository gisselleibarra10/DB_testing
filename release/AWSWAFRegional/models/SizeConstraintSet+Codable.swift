...
extension WafRegionalClientTypes.SizeConstraintSet: Swift.Codable {
    ...
    public init (from decoder: Swift.Decoder) throws {
        ...
        name = nameDecoded
        let sizeConstraintsContainer = try containerValues.decodeIfPresent([WafRegionalClientTypes.SizeConstraint?].self, forKey: .sizeConstraints)
        var sizeConstraintsDecoded0:[WafRegionalClientTypes.SizeConstraint]? = nil
        if let sizeConstraintsContainer = sizeConstraintsContainer {
            sizeConstraintsDecoded0 = [WafRegionalClientTypes.SizeConstraint]()
