...
extension KeyspacesClientTypes.CapacitySpecificationSummary: Swift.Codable {
    ...
    public func encode(to encoder: Swift.Encoder) throws {
        ...
        if let lastUpdateToPayPerRequestTimestamp = self.lastUpdateToPayPerRequestTimestamp {
            try encodeContainer.encode(lastUpdateToPayPerRequestTimestamp.timeIntervalSince1970, forKey: .lastUpdateToPayPerRequestTimestamp)
        }
    ...
    public init (from decoder: Swift.Decoder) throws {
        ...
        let lastUpdateToPayPerRequestTimestampDecoded = try containerValues.decodeIfPresent(ClientRuntime.Date.self, forKey: .lastUpdateToPayPerRequestTimestamp)
