...
extension MediaConvertClientTypes {
    ...
    public enum NoiseFilterPostTemporalSharpeningStrength: Swift.Equatable, Swift.RawRepresentable, Swift.CaseIterable, Swift.Codable, Swift.Hashable {
        case high
        case low
        case medium
        ...
        public init(from decoder: Swift.Decoder) throws {
            ...
            self = NoiseFilterPostTemporalSharpeningStrength(rawValue: rawValue) ?? NoiseFilterPostTemporalSharpeningStrength.sdkUnknown(rawValue)
        }
    }
}
