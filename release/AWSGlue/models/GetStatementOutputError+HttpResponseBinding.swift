...
extension GetStatementOutputError: ClientRuntime.HttpResponseBinding {
...
extension GetStatementOutputError {
    public init(errorType: Swift.String?, httpResponse: ClientRuntime.HttpResponse, decoder: ClientRuntime.ResponseDecoder? = nil, message: Swift.String? = nil, requestID: Swift.String? = nil) throws {
        ...
        case "IllegalSessionStateException" : self = .illegalSessionStateException(try IllegalSessionStateException(httpResponse: httpResponse, decoder: decoder, message: message, requestID: requestID))
