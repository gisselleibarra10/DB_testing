...
extension CognitoIdentityProviderClientTypes.DeviceType: Swift.Codable {
    ...
    public init (from decoder: Swift.Decoder) throws {
        ...
        let deviceCreateDateDecoded = try containerValues.decodeIfPresent(ClientRuntime.Date.self, forKey: .deviceCreateDate)
        ...
        let deviceLastAuthenticatedDateDecoded = try containerValues.decodeIfPresent(ClientRuntime.Date.self, forKey: .deviceLastAuthenticatedDate)
